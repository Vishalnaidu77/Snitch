          ...
          <div className="mt-6 mb-6 relative">
            ...
            <div className="relative flex justify-center text-xs">
              ...
              <button 
                ...
                className="flex w-full items-center justify-center gap-2 border border-gray-200 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-sm font-light group"
              >
